...
async def countRecent(initConfig=Body(...)):
    ...
    default['twitter']['countRecent']['account'] = initConfig['list']
    default['twitter']['countRecent']['keyword'] = initConfig['keyword']
    default['twitter']['outsideTagIsAND'] = initConfig['outsideTagIsAND']
    default['twitter']['start'] = initConfig['begin']
    default['twitter']['end'] = initConfig['stop']
    return main3.get_all_tweets_count(default)
